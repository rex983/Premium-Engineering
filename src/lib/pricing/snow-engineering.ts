...
export function calcSnowEngineering(
  ...
  return {
    ...
    originalTrusses,
    extraTrussesNeeded,
    trussPrice: trussLineCost,
    hatChannelSpacing: hatChannelSpacing > 0 ? `${hatChannelSpacing}"` : "—",
    originalHatChannels,
    extraChannelsNeeded,
    hatChannelPrice: channelLineCost,
    girtSpacing: girtSpacing > 0 ? `${girtSpacing}"` : "—",
    originalGirts,
    extraGirtsNeeded,
    girtPrice: girtLineCost,
    verticalSpacing: verticalSpacing > 0 ? `${verticalSpacing}"` : "—",
    originalVerticals,
    extraVerticalsNeeded,
    verticalPrice: verticalLineCost,
    totalEngineering: trussLineCost + channelLineCost + girtLineCost + verticalLineCost,
  };
}
